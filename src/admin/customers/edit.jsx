...
import { Get,Update,Edit} from '../../store/actions/CustomerAction'

export default function Page() {

    const {id} = useParams();
    const dispatch = useDispatch();
    let {validations,single,data,loading} = useSelector( store => store.CustomerReducer);
    ...
    useEffect(() => {
         ...
         if(single){
             setForm({
                ...
                street_address:single.street_address,
                city:single.city,
                state:single.state,
                 ...
                 <div className="row">
                        <div className="mt-2 col-12">
                            <div className="page-title-box d-flex align-items-center justify-content-between">
                                   <h4 className="font-roboto mb-0 font-size-18">Edit Customer </h4>
